...
import com.stockmarket.stockpro.Repository.UserRepository;
...
public class UserController {
    ...
    public ResponseEntity<Object> reactuserapi2(@RequestBody User user)
    ...
    public ResponseEntity<User> getUser() throws AddressException, MessagingException {
        User usr = new User();
    ...
    public void sendemail(Long userid) throws AddressException, MessagingException {
        ...
        try {
            ...
            message.setRecipients(Message.RecipientType.TO, InternetAddress.parse("skb15428@gmail.com"));
